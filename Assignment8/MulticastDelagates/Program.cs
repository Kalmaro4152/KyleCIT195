namespace assignment8ex1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            HereComesTheSun.end();
            */
            Program.SunShine sunny = new Program.SunShine(HereComesTheSun.chorus);
            sunny += HereComesTheSun.verse1;
            sunny += HereComesTheSun.chorus;
            sunny += HereComesTheSun.verse2;
            sunny += HereComesTheSun.chorus2;
            sunny += HereComesTheSun.verse3;
            sunny += HereComesTheSun.chorus;
            sunny += HereComesTheSun.chorus;
            sunny += HereComesTheSun.end;
            sunny();

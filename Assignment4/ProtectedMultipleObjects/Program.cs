...
namespace AnimalInheritance
{
    ...
    class Faction
    {
        protected string name; // only accessible within this class
        protected int strength; //accessible from derived classes
        protected string color;  // accessible from any class
